...
// 倒数系数表声明 (定义在 csiir_div_lut_data.h)
extern const ap_uint<17> DF_RECIP_Q16[26];

// GWA LUT 声明
extern const ap_uint<17> GWA_RECIP_LUT[257];
...
static const ap_uint<17> GWA_RECIP_MAIN[257] = {
    // 预计算值 (Python 生成)
